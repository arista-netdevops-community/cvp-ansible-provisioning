...
%{endif}%{if cvp_cluster_nodes_number > 1}
node2:
  ...
  cluster_interface: ${cvp_node2_device_interface}
  interfaces:
...
node3:
  ...
  cluster_interface: ${cvp_node3_device_interface}
  interfaces:
